...
SECRET_KEY = 'django-insecure-m(6+2=^z!27y=7c%6k5ca3a36qx^oz!o()y9$(b2$wn$!l17y0'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,
    'DEFAULT_AUTHENTICATION_CLASSES': [  # через какие классы можно проверить аутентификацию пользователя
